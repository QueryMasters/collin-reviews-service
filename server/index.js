...
app.post('/reviews/:productId', (req, response) => {
  ...
  // console.log(values);
  let sql =
    'INSERT INTO reviews(headline, body, stars, posted, helpful, verified, author_id, product_id) values($1, $2, $3, $4, $5, $6, $7, $8)'
...
app.put('/reviews/:productId', (req, response) => {
  ...
  const values = [data.body, data.product_id]
...
app.delete('/reviews/:productId', (req, response) => {
  ...
  const values = [data.reviewId, data.product_id]
